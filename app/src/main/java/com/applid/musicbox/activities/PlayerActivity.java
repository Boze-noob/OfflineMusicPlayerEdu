  ...
  //  private ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(instance!=null&&place==false){
          ...
          //  setBackground();
            circleBarVisualizer.setPlayer(mMediaPlayer.getAudioSessionId());
        }else {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //dodano
            if(mSeekBar.getProgress() == mMediaPlayer.getDuration()/1000)
            {
                circleBarVisualizer.release();
            }
    ...
    public void setBackground(){
        ...
        Palette.from(bitmap).maximumColorCount(32).generate(new Palette.PaletteAsyncListener() {
            ...
            public void onGenerated(Palette palette) {
                ...
                //ovo ostaje komentirano (uradeno prije vizualizatora)
